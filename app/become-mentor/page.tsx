...
const BENEFITS = [
  ...
  {
    icon: "public",
    title: "Студенты отовсюду",
    desc: "Помогай студентам из Казахстана, Узбекистана, Кыргызстана и других стран.",
  },
  {
    icon: "shield",
...
const STEPS = [
  ...
  },
  {
    ...
    desc: "Студенты находят тебя, оплачивают услугу, и ты начинаешь работать",
    icon: "handshake",
  },
]
        ...
        <div className="relative max-w-4xl mx-auto text-center">
          ...
          <ScrollReveal variant="blur-in" delay={200} duration={800}>
            <p className="text-lg sm:text-xl text-gray-400 max-w-2xl mx-auto mb-10 leading-relaxed">
              ...
              Стань ментором и помогай студентам из Казахстана.
            </p>
          </ScrollReveal>
            ...
            <div className="lg:sticky lg:top-32">
              <ScrollReveal variant="fade-right" duration={800}>
                ...
                <p className="text-gray-500 leading-relaxed">
                  Сосредоточься на помощи студентам — платформа возьмёт
