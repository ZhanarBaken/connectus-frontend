...
function makeSettings(overrides: Partial<SiteSettings> = {}): SiteSettings {
  return {
    ...
    consultation_complete_chat_message: "",
    ...
    consultation_complete_email_subject: "",
    consultation_complete_email_heading: "",
    consultation_complete_email_body: "",
    ...
    consultation_confirmed_email_subject: "",
    consultation_confirmed_email_heading: "",
    consultation_confirmed_email_body: "",
