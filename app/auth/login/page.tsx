    ...
    <div className="min-h-screen bg-[#fafafa] flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-8">
          ...
          {/* Telegram — only for browser users; inside a Mini App this
              would open the bot link from within Telegram, which is
              nonsensical. Mini App users sign in via the auto-login
              overlay triggered by the useEffect above. */}
          {!isInTelegram && (
            <button
              type="button"
